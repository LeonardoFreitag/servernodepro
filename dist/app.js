...
const configRoute = require("./routes/config-route"); // mettre smart
...
app.use(express.static(path.join(__dirname, "images"))); //rotas reactmettre
...
app.use("/subgrupos", subgruposRoute); // rotas mettre smart
